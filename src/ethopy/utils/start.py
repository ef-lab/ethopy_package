...
class PyWelcome:
    ...
    def create_animal(self):
        ...
        # Add the layout
        self.animal_screen = menu_animal.add.label(
            "",
        ...
        menu_animal = self.add_num_pad(
            menu_animal, self.log_animal_id, self.animal_screen
        )
    ...
    def create_task(self):
        ...
        # Add the layout
        self.task_screen = menu_task.add.label(
            "",
            background_color=None,
            margin=(10, 0),
            selectable=True,
    ...
    def add_num_pad(self, menu, log_function, screen) -> "pygame_menu.Menu":
        ...
        b2 = f1.pack(
            menu.add.button("2", lambda: self._press(2, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_CENTER,
        )
        b3 = f1.pack(
            menu.add.button("3", lambda: self._press(3, screen), cursor=cursor),
        ...
        b5 = f2.pack(
            menu.add.button("5", lambda: self._press(5, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_CENTER,
        )
        b6 = f2.pack(
            menu.add.button("6", lambda: self._press(6, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_RIGHT,
        )
        menu.add.vertical_margin(5)
        ...
        b8 = f3.pack(
            menu.add.button("8", lambda: self._press(8, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_CENTER,
        )
        b9 = f3.pack(
            menu.add.button("9", lambda: self._press(9, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_RIGHT,
        )
        menu.add.vertical_margin(5)
        ...
        b0 = f4.pack(
            menu.add.button("0", lambda: self._press(0, screen), cursor=cursor),
            align=pygame_menu.locals.ALIGN_CENTER,
        )
        dot = f4.pack(
            menu.add.button(" .", lambda: self._press(".", screen), cursor=cursor),
    ...
    def log_animal_weight(self, curr):
        try:
            ...
            self.logger.put(
                table="MouseWeight",
                tuple=dict(
                    animal_id=self.logger.get_setup_info("animal_id"),
                    weight=self.weight,
                ),
                schema="mice",
            )
